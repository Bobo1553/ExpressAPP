...
public class BasisPageActivity extends AppCompatActivity implements iBasisPage{
    ...
    private ExpressInfoManager expressInfoManager=new ExpressInfoManager();
            ...
            public boolean onNavigationItemSelected(MenuItem item)
            {
                switch (item.getItemId())
                {
                    case R.id.menu_drawer_item_send :
                        getSupportFragmentManager().beginTransaction().replace(R.id.basispage_layout_content, new SendFragment(expressInfoManager,guid)).commit();
                        break;
                    case R.id.menu_drawer_item_search:
                        getSupportFragmentManager().beginTransaction().replace(R.id.basispage_layout_content,new InformationFragment(expressInfoManager,guid)).commit();
                        break;
